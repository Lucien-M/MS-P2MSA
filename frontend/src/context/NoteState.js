...
const NoteState = (props) => {
  ...
  const getNotes = async () => {
    const response = await fetch(
      `${process.env.REACT_APP_BACKEND_URL}api/notes/fetchallnotes`,
      {
        method: "GET",
        headers: {
  ...
  const addNote = async (title, description, tag) => {
    const response = await fetch(
      `${process.env.REACT_APP_BACKEND_URL}api/notes/addnote`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const deleteNote = async (id) => {
    await fetch(
      `${process.env.REACT_APP_BACKEND_URL}api/notes/deletenote/${id}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
  ...
  const editNote = async (id, title, description, tag) => {
    await fetch(
      `${process.env.REACT_APP_BACKEND_URL}api/notes/updatenote/${id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
